export declare enum AnalysisStatuses {
...
export declare enum DynamoIndexes {
    LSIA = "lsia-index",
    LSIB = "lsib-index"
}
export declare enum JobStatuses {
...
export declare enum WebhookResponses {
    FACE_MISSMATCH = "FACE_MISSMATCH",
...
export declare enum PKs {
    JOB = "JOB"
}
export declare enum DynamoAttributes {
    PK = "pk",
    SK = "sk",
    LSIA = "lsia",
    LSIB = "lsib"
